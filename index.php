...
<div class="main_section_agile fixed-top" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
            ...
            <ul class="agile_forms">
                <li><a class="active" href="login.php"><i class="fa fa-sign-in" aria-hidden="true">
                        </i> Sign In now</a> </li>
            ...
            <div class="video-grid-single-page-agileits">
                <div data-video="E91gAjunqOM" id="video">
                    <img src="assets/images/hu.jpg" alt=""
                         class="img-responsive"style="height: 400px;border:5px solid pink;"></div>
            </div>
            <div class="text-warning text-center h1">
	...
	<div class="container">
		...
		<div class="col-md-7 wthree-services-bottom-grids">
			<div class="wthree-services-left">
                <img class="img-rounded" src="assets/images/bg2.jpg" alt="" style="height: 400px;border:8px solid pink">
			</div>
			<div class="wthree-services-right">
                <img src="assets/images/hu.jpg" alt="" style="height: 400px;width: 300px">
			</div>
			<div class="clearfix"> </div>
		</div>
...
<!-- services -->
<hr>
<div class="services" id="services"style="background-color: #f5dbff;border: 5px solid palegreen">
	<div class="container">  
...
<!-- Gallery -->
<hr>
<section class="portfolio-w3ls"style="background-color: #d3f1ff;border: 5px solid palegreen" id="gallery">
                 ...
                 <div class="row">
                     <div class="col-md-4">
                         <div class="col-md-3 col-xs-3 gallery-grid gallery1">
                             <a href="assets/images/hu.jpg" class="swipebox">
                                 <img src="assets/images/ko.jpg" class="img-responsive img-rounded" alt="/"
                                      style="300px">
                                 <div class="textbox">
                                     <h4>Students</h4>
                     ...
                     <div class="col-md-4">
                         <div class="col-md-3 col-xs-3 gallery-grid gallery1">
                             <a href="images/g12.jpg" class="swipebox">
                                 <img src="images/jeff.jpg" class="img-responsive img-rounded" alt="/"
                                      style="width: 100%">
                                 <div class="textbox">
                                     <h4>Student</h4>
                                     <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                     ...
                     <div class="col-md-4">
                         <div class="col-md-3 col-xs-3 gallery-grid gallery1">
                             <a href="images/g12.jpg" class="swipebox">
                                 <img src="assets/images/ul.jpg" class="img-responsive img-rounded" alt="/"
                                      style="width: 100%">
                                 <div class="textbox">
                                     <h4>Student</h4>
                                     <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
...
<!-- team -->
<hr>
<div class="team-w3l" id="team"style="border: 5px solid palegreen">
	<div class="container">
...
<!-- contact -->
<hr>
		<div class="w3l-form" style="background-color: #377fab;border: 5px solid palegreen">
...
<div id="map" style="width: 100%;height: 500px">
        <iframe src="https://www.google.com/maps/embed?v1/place?key=API_KEY&q_Space+Needle,Thogoto+WA"></iframe>
</div>
<div class="w3layouts_copy_right"style="background-color: #377fab;border: 5px solid palegreen">
	<div class="container">
