    ...
    <div class="agileits_w3layouts_banner_nav">
        <nav class="navbar navbar-default">
            <div class="navbar-header navbar-left">
                ...
                <h1><a class="navbar-brand" href="index.php"><i class="fa fa-leanpub" aria-hidden="true">

                        </i> STUDENT COMPLAINT SYSTEM</a></h1>
    ...
    <div class="col-md-5">
        <div class="video-grid-single-page-agileits">
            <div data-video="E91gAjunqOM" id="video">
                <img src="assets/images/hu.jpg" alt="" class="img-responsive"
                     style="height: 450px;margin-right: 200px;border: 5px solid palegreen"> </div>
        </div>
        <div class="text-primary text-center h1">
            <h4>Welcome To Our Beautiful School</h4>
        </div>
    </div>
    <div class="col-md-1"></div>
    <div class="col-md-4" style="background-color: #bb90b6;border: 5px solid palegreen">
        <h1 class="text-center message" style="cursor: pointer"><u><b class="text-white">Student Complaint <br> System</b></u></h1>
        <form  method="post" action="registration.php" id="form">
            <!--                   <button type="button" onclick="document.getElementById('form').style.fontSize='35px'">Click Me!</button>-->

            <div class="form-group">
                <ul>
                    <li class="text message">Name of Applicant :  </li>
                    <i class="fa fa-user-o" aria-hidden="true"></i>
                        <input class="form-control" name="fullname" type="text" required="">

                    <li class=" text message">Username :  </li>
                    <i class="fa fa-envelope" aria-hidden="true"></i>
                        <input class="form-control" name="email" type="email" required="">

                            <li class="text message">Password :  </li>
                            <i class="fa fa-lock" aria-hidden="true"></i>
                                <input  class="form-control" name="password" type="password" required="">
                    <li class="text message">Contact :  </li>
            ...
            <p class="text-warning">Already Registered?<a href="login.php">Sign -In</a></p>
        </form>
    </div>
    <div class="col-md-1"></div>
</div>
...
<hr>
<hr class="bg-primary">
<div class="about-top" id="about"style="background-color: #377fab;border: 5px solid palegreen">
    <div class="container">
        ...
        <div class="col-md-7 wthree-services-bottom-grids">
            <div class="wthree-services-left">
                <img class="img-rounded" src="assets/images/bg2.jpg" alt=""
                     style="height: 400px;border: 5px dotted palegreen">
            </div>
...
<!-- services -->
<hr>
<div class="services" id="services"style="background-color: #f5dbff">
    <div class="container">
        ...
        <div class="services-w3ls-row">
            <div class="col-xs-4 services-grid agileits-w3layouts">
                ...
                <p>We Offer 100% Scholarship to International student and Local students.</p>
            </div>
            <div class="col-xs-4 services-grid agileits-w3layouts">
                <h6>02</h6>
                <h5>Skilled Lecturers</h5>
                <p>Highly Valued Lectures Both Locally And International.</p>
            ...
            <div class="col-xs-4 services-grid agileits-w3layouts">
                ...
                <p>Well Equiped Library With well arrange Books on shelves</p>
            </div>
            <div class="clearfix"> </div>
        </div>
    </div>
...
<!-- Gallery -->
<hr>
<section class="portfolio-w3ls"style="background-color: #d3f1ff" id="gallery">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="col-md-3 col-xs-3 gallery-grid gallery1">
                <a href="images/g12.jpg" class="swipebox">
                    <img src="assets/images/ko.jpg" class="img-responsive img-rounded" alt="/" style="300px">
                    <div class="textbox">
                        <h4>Students</h4>
        ...
        <div class="col-md-4">
            <div class="col-md-3 col-xs-3 gallery-grid gallery1">
                <a href="images/g12.jpg" class="swipebox">
                    <img src="images/jeff.jpg" class="img-responsive img-rounded" alt="/" style="width: 100%">
                    <div class="textbox">
                        <h4>Student</h4>
                        <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                    </div>
        ...
        <div class="col-md-4">
            <div class="col-md-3 col-xs-3 gallery-grid gallery1">
                <a href="images/g12.jpg" class="swipebox">
                    <img src="assets/images/ul.jpg" class="img-responsive img-rounded" alt="/" style="width: 100%">
                    <div class="textbox">
                        <h4>Student</h4>
                        <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                    </div>
    ...
    <div class="container">
        ...
        <div class="team-w3l-grid">
            <div class="col-md-4 col-xs-4 about-poleft t1">
                <div class="about_img"><img src="assets/images/ol.jpg"style="height: 400px" alt="">
                    <h5>Olivia</h5>
                    <div class="about_opa">
                        <p>Professor</p>
            ...
            <div class="col-md-4 col-xs-4 about-poleft t2">
                <div class="about_img"><img src="assets/images/mu.jpg" alt="">
                    <h5>Omondi</h5>
                    <div class="about_opa">
            ...
            <div class="col-md-4 col-xs-4 about-poleft t3">
                <div class="about_img"><img src="assets/images/ku.jpg" alt="">
                    <h5>Jeff</h5>
                    <div class="about_opa">
                        <p>Lecturers</p>
                        <ul class="fb_icons2 text-center">
...
<div class="w3layouts_copy_right">
    <div class="container">
        <p>© - 2022 Student Complaints System.
            All rights reserved | Design by <a href="omondi jeff">Omondi Jeff.</a> Developed
            By Omondi Jeff</p>
    </div>
</div>
